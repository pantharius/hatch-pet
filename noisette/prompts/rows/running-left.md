Create a single horizontal sprite strip for the Codex app digital pet `noisette` in the state `running-left`.
...
- The sprite should read as a compact left-facing/run-to-the-left pose cycle, not as several squirrels blended together.
